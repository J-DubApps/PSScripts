...
Write-Host "Found $($results.Count) autostart entries." -ForegroundColor Green
...
$lblInfoProps = @{
    Text      = "  Computer: $computerName   |   User: $userName   |   OS: $osCaption   |   Context: $elevationTag   |   Entries: $($results.Count)"
    Dock      = 'Top'
    Height    = 32
